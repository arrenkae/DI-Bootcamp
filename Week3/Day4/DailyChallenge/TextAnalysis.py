...
class Text:
    ...
    def wordcount(self):
        ...
        'yourselves', 'he', "he'd", 'him', 'his', 'himself', 'she', "she'd", "she's", 'her', 'hers', 'herself', 'it', "it's", 'its', 'itself', 'they', 'them', 'their', 'theirs', 
        'themselves', 'what', 'which', 'who', 'whom', 'this', 'that', "that'll", 'these', 'those', 'am', 'is', 'are', 'was', 'were', 'be', 'been', 'being', 'have', 'has', 'had', 
        ...
        "mightn't", 'mustn', "mustn't", 'needn', "needn't", 'shan', "shan't", 'shouldn', "shouldn't", 'wasn', "wasn't", 'weren', "weren't", 'won', "won't", 'wouldn', "wouldn't", 'would']
        remove = '''!()-—[]{};:'"\,<>./?@#$%^&*_~♦1234567890'''
        words = []
        for word in self.text.lower().split():
            word_clean = word.lower().strip(remove)
    ...
    def unique_words(self):
        ...
        return [word for word in self.wordcount if self.wordcount[word] == 1]
